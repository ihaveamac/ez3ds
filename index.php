...
<div class="container">
  ...
  <p>CFW can be easily set up on any console that is on 9.2.0-20 or lower. Consoles on 10.7.0-32 or lower can be downgraded for free, those on 11.0.0/11.1.0 can be with hardware modifications (hardmod) or another system with CFW already set up.</p>
  ...
  <p>Be sure to also check out the <a href="faq.php">Frequently Asked Questions</a>.</p>
</div>
