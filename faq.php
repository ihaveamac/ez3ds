...
<div class="container">
  ...
  <hr>
  <h3 id="safe">Is Homebrew/Custom Firmware safe? <small><a href="#safe">#safe</a></small></h3>
  ...
  <ul>
    ...
    <li>Make sure you're using the <b>latest</b> version of every tool (sysDowngrader, Decrypt9WIP, SafeA9LHInstaller, Hourglass9) before continuing. Several accidents and bricks happen to users using older versions without realizing!</li>
  ...
  <hr>
  <h3 id="eshop-games">How can I use the eShop and play games online without updating? <small><a href="#eshop-games">#eshop-games</a></small></h3>
  ...
  <hr>
  <h3 id="systransfer">Is System Transfer safe to use with a system that has Custom Firmware? <small><a href="#systransfer">#systransfer</a></small></h3>
